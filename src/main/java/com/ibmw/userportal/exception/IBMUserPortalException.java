...
import com.ibmw.userportal.config.PropertiesConfig;

import static com.ibmw.userportal.exception.EntityType.USERPROFILE;
import static com.ibmw.userportal.exception.ExceptionType.ENTITY_NOT_FOUND;

import java.text.MessageFormat;
import java.util.Optional;
@Component
public class IBMUserPortalException 
{

	 private static PropertiesConfig propertiesConfig;

	    @Autowired
	    public IBMUserPortalException(PropertiesConfig propertiesConfig) {
	    	IBMUserPortalException.propertiesConfig = propertiesConfig;
	    }
